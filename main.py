...
def predict_form_post(
    ...
    try:
        ...
        score_percent_1 = int(result['phishing_score_model1'] * 100)
        score_percent_2 = int(result['phishing_score_model2'] * 100)
        max_score_percent = int(result['max_phishing_score'] * 100)
